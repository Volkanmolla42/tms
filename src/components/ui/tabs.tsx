...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-start rounded-lg bg-slate-100 p-1 text-slate-500",
      className
    )}
    {...props}
  />
